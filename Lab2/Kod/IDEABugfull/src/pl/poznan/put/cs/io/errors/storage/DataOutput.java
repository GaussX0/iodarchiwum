...
public class DataOutput {
    ...
    /**
     * Passes the pointer to a desired output method, specified in the constructor.
     *
     * @return pointer to the desired output method - file or system console.
     * @throws IOException thrown if the destination file was not found.
     */
